...
*****Already Have an account part "Login" is not a href change it to href*****
   ...
   return (
     ...
     <div className="row">
      <div className="col container">
        ...
        <div className="col" style={{padding: "11em 0em 0em 0em"}}>
